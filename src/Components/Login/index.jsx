    ...
    return (
        <div className="loginwrap">
            ...
            <div className="welcomemink">
                ...
                <input type="text" value={email} placeholder="Email" name="uname" required onChange={handleEmail} />
                <label htmlFor="psw">
                    <img src="/assets/images/icons/password.svg" alt="" />
                </label>
                <input type="password" value={pass} placeholder="Password" name="psw" required onChange={handlePass} />
                <button type="submit" className="myminkbutton">Sign in</button> {/* Changed <a> to <button> */}
            </form>
            </div>
        </div>
      </div>
