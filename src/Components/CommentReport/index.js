        ...
        const fetchData = async () => {
            try {
                ...
                await Promise.all(reportsSnapshot.docs.map(async (reportDoc) => {
                    ...
                    const commentId = reportDoc.data().commentId;
                    ...
                    data.push({...postData,...reportDoc.data(),comment,commentId,commentDate});
                }));
                            ...
                            <div className="reportwrap">
                                ...
                                <span>
                                    ...
                                    >
                                        ...
                                        <MenuItem onClick={()=>openModal(post)}>Delete Comment</MenuItem>
